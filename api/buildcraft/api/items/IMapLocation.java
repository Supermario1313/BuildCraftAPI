...
public interface IMapLocation extends INamedItem {
    enum MapLocationType {
        ...
        public static MapLocationType getFromStack(@Nullable ItemStack stack) {
        ...
        public void setToStack(@Nullable ItemStack stack) {
    ...
    IZone getZone(@Nullable ItemStack stack);
    ...
    List<BlockPos> getPath(@Nullable ItemStack stack);

    /** This function can be used for SPOT types only.
     * 
     * @param stack
     * @return The side of the spot. */
    EnumFacing getPointSide(@Nullable ItemStack stack);
}
